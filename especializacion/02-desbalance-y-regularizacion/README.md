# Desbalance de clases y regularización

Evaluación con F1 macro y balanced accuracy; regularización L2 y Dropout en regresión.

**Herramientas:** Python, TensorFlow/Keras, NumPy, pandas, scikit-learn y Matplotlib, según los imports del cuaderno.

**Datos:** Clasificación sintética desbalanceada y diabetes de scikit-learn.

## Abrir el proyecto

[Ver el notebook](notebook.ipynb) · [Abrir en Colab](https://colab.research.google.com/github/juandavidtejedormedina-hub/app-streamlite/blob/main/especializacion/02-desbalance-y-regularizacion/notebook.ipynb)
